...
xlims <- list(c(-2, 1.3), c(-1.1, 1.1), c(-1.6, 2))
ylims <- list(c(-1.5, 1.2), c(-1.6, 1.9), c(0.1, 1.7))
for (i in 1:length(hobbies_pairs)) {
  cat("Para kolumn", labels_pairs[[i]][1], "&", labels_pairs[[i]][2], ":\n")
  n <- sum(dane_pairs[[i]])
  P <- dane_pairs[[i]]/n
